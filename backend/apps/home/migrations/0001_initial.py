    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password_renewal_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='password_renewal_template', to='home.emailtemplate')),
                ('verify_email_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='verify_email_template', to='home.emailtemplate')),
            ],
            options={
